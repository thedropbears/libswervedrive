...
def assert_scaling_bounds(beta_dot_b, beta_2dot_b, phi_2dot_b,
    ...
    ds_lower, ds_upper, d2s_lower, d2s_upper = \
        scaler.compute_scaling_bounds(dbeta, d2beta, dphi_dot)
...
def test_positive_velocities_in_range():
    ...
    assert_scaling_bounds(beta_dot_b, beta_2dot_b, phi_2dot_b,
                          dbeta, d2beta, dphi_dot)
